-- Final AI Chat System Setup (Fixed Parameter Name Conflicts)
-- This script resolves the ambiguous column reference issues

-- Helper function to check if column exists (fixed parameter names)
...
-- Helper function to check if table exists (fixed parameter names)
