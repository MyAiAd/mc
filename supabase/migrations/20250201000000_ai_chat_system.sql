...
-- This migration creates the necessary tables for AI chat functionality
...
CREATE TABLE IF NOT EXISTS ai_api_keys (
    ...
    api_key_name VARCHAR(100) DEFAULT NULL, -- Optional name for the key
...
CREATE TABLE IF NOT EXISTS chat_messages (
    ...
    content TEXT NOT NULL,
    rag_documents_used UUID[] DEFAULT '{}', -- Array of document IDs used for RAG
...
BEGIN
    ...
    RAISE NOTICE '📝 Created tables: ai_api_keys, rag_documents, chat_conversations, chat_messages';
    RAISE NOTICE '🔒 RLS policies applied for proper security';
